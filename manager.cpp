...
void Manager::authorize()
{
    ...
    webkit_web_view_load_uri(webView, "https://oauth.vk.com/authorize?client_id=4381194&scope=friends,messages,offline&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token");
